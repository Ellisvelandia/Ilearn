...
export const metadata: Metadata = {
  title: "Sign In | iLearnAI",
  description: "Sign in to your iLearnAI account",
};
        ...
        <div className="relative hidden h-full flex-col bg-muted/40 dark:bg-muted p-10 text-foreground dark:text-white lg:flex">
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;Welcome back to iLearnAI. Continue your learning journey with our AI-powered tools and expert guidance.&rdquo;
              </p>
            </blockquote>
          </div>
        </div>
